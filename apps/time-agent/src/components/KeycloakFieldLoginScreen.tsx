...
export const KeycloakFieldLoginScreen: React.FC<KeycloakFieldLoginScreenProps> = ({ onLogin }) => {
  return (
    <div className="flex flex-col min-h-screen w-screen bg-[#fbf9f8] text-[#1b1c1c] font-sans">
      {/* TopAppBar */}
      <header className="bg-[#fbf9f8] border-b border-[#cfc4c5] w-full top-0 flex items-center justify-between px-3 h-10 shrink-0">
        <div className="flex items-center gap-2">
          ...
          />
          <span className="font-bold text-sm text-[#1b1c1c]">Time Agent Field Portal</span>
        </div>
        <div>
      ...
      <main className="flex-grow flex flex-col px-3 py-8 gap-6 justify-center max-w-md mx-auto w-full">
        ...
        <div className="flex justify-center w-full">
          <div className="font-mono text-[11px] leading-tight text-[#4c4546] bg-[#f6f3f2] border border-[#CCCCCC] rounded px-3 py-1.5 inline-flex items-center gap-2 shadow-xs">
        ...
        <div className="bg-[#fbf9f8] rounded border border-[#CCCCCC] p-4 shadow-sm flex flex-col gap-5 w-full">
          <div className="flex flex-col gap-1 text-left">
            <h1 className="font-bold text-base text-[#1b1c1c]">Sign In</h1>
            <p className="text-xs text-[#666666]">Enter your enterprise field credentials.</p>
          </div>
          ...
          <form className="flex flex-col gap-4" onSubmit={(e) => { e.preventDefault(); onLogin(); }}>
            {/* Username */}
            <div className="flex flex-col gap-1 text-left">
              <label className="text-xs font-semibold text-[#1b1c1c]" htmlFor="username">Username / Field ID</label>
              <input 
                className="h-10 px-3 bg-[#fbf9f8] border border-[#CCCCCC] rounded text-xs text-[#1b1c1c] w-full font-mono focus:outline-none focus:border-black" 
                id="username" 
                type="text" 
            ...
            {/* Password */}
            <div className="flex flex-col gap-1 text-left">
              <label className="text-xs font-semibold text-[#1b1c1c]" htmlFor="password">Password</label>
              <input 
                className="h-10 px-3 bg-[#fbf9f8] border border-[#CCCCCC] rounded text-xs text-[#1b1c1c] w-full font-mono focus:outline-none focus:border-black" 
                id="password" 
                type="password" 
          ...
          <div className="flex justify-center mt-1">
            <a className="text-[11px] text-[#666666] hover:text-[#E1B91B] underline cursor-pointer" href="#">Need help logging in?</a>
          </div>
        </div>
      </main>

      {/* Footer */}
      <footer className="bg-[#fbf9f8] border-t border-[#cfc4c5] w-full bottom-0 flex flex-col items-center justify-center gap-1 py-3 px-3 shrink-0">
        <span className="text-[10px] text-[#666666]">Connected to Keycloak 24.0 (Enterprise SSO)</span>
        <div className="flex gap-4 mt-0.5 text-[10px] text-[#666666]">
